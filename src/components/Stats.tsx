	...
	return (
		<div id='stats'>
			<div className='my-16'>
				...
				<p className='mb-2 text-3xl font-retro text-green-600 tracking-widest'>
					{answer.toUpperCase()}
				</p>
				{isWon ? (
					<p className='mb-2 font-retro'>guessed in {rows.length} tries</p>
				) : (
					''
				)}
			</div>
            ...
            ${
						...
						{showShareButton ? (
							<div id='shareButton' className='flex align-center'>
								<div style={{ marginTop: '2px' }} className='mr-1'>
